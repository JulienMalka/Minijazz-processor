...
op_alu_op = {6:"[].0.1.1.1.0.0", 58:"op_alu_opx", 14:"[].0.1.1.0.0.1", 22:"[].0.1.1.0.1.0", 30: "[].0.1.1.0.1.1", 38:"[].0.1.1.1.0.0", 46: "[].0.1.1.1.0.1", 54: "[].0.1.1.1.1.0", 12:"[].1.0.0.0.0.1", 20:"[].1.0.0.0.1.0", 28:"[].1.0.0.0.1.1", "default":"[].0.0.0.0.0.0"}
